...
export default function AboutSection() {
  return (
    <section id="about" className="w-full flex flex-col items-center justify-center bg-accent dark:bg-accent/20">
            ...
            <div className="space-y-4">
              {experiences.map((experience) => (
                <Card
                  ...
                  className="border-border/70 bg-background/70 shadow-lg shadow-black/5 transition-transform duration-300 hover:-translate-y-1"
                >
